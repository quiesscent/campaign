...
from .serializers import OrderStkPushSerializer
...
# @csrf_exempt
class OrderStkPushView(APIView):
    @swagger_auto_schema(request_body=OrderStkPushSerializer)
    def post(self, request):
        serializer =  OrderStkPushSerializer(data=request.data)
        ...
        if serializer.is_valid():
            ...
            request_data = {
                ...
                "CallBackURL": "https://9333-41-209-60-94.ngrok-free.app/api/order_callback",
                "AccountReference": 'Order For Okiya Merch',
                "TransactionDesc": "Okiya Omtata Campaign Merch"
            }
